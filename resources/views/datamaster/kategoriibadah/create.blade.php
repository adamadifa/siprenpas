<form action="{{ route('kategoriibadah.store') }}" method="POST" id="formKategoriIbadah">
    @csrf
    <x-input-with-icon-label icon="ti ti-file-description" label="Nama Kategori Ibadah" name="kategori_ibadah" required="true" />
    ...
    <div class="form-group mt-3">
        <button class="btn btn-primary w-100 shadow-sm d-flex align-items-center justify-content-center gap-2" type="submit" id="btnSimpan" style="background-color: #064e3b; border-color: #064e3b">
            ...
            <span class="fw-bold">Simpan Data Kategori Ibadah</span>
        </button>
    </div>
</form>
