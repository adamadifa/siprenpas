<form action="{{ route('kegiatanibadah.store') }}" method="POST" id="formKegiatanIbadah">
    @csrf
    <x-input-with-icon-label icon="ti ti-file-description" label="Nama Kegiatan Ibadah" name="nama_kegiatan" required="true" />
    ...
    <div class="form-group mt-3">
        <button class="btn btn-primary w-100 shadow-sm d-flex align-items-center justify-content-center gap-2" type="submit" id="btnSimpan" style="background-color: #064e3b; border-color: #064e3b">
            ...
            <span class="fw-bold">Simpan Data Kegiatan Ibadah</span>
        </button>
    </div>
</form>
