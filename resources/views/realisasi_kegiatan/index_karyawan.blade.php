@extends('layouts.app')
@section('titlepage', 'Realisasi Kegiatan Saya')
        ...
        <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 class="mb-1 fw-extrabold" style="color: #064e3b; letter-spacing: -0.5px;">Realisasi Kegiatan Saya</h4>
                        <p class="text-muted mb-0 small">Monitoring dan pencatatan laporan realisasi kegiatan kerja Anda</p>
                    </div>
                </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            ...
                            <li class="breadcrumb-item active fw-medium" style="color: #064e3b">
                                <i class="ti ti-activity me-1"></i> Realisasi Kegiatan Saya
                            </li>
                        </ol>
                    </nav>
                </div>
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
            <div>
                <button class="btn d-flex align-items-center gap-2 shadow-sm text-white px-4" id="btncreateRealisasiKegiatan"
                    style="background-color: #064e3b; border-radius: 8px; height: 38px;">
                    <i class="ti ti-plus fs-5"></i>
                    <span class="fw-semibold">Tambah Realisasi Kegiatan</span>
                </button>
            </div>
            ...
            @empty
                <div class="card border-0 shadow-sm">
                    <div class="card-body text-center p-5">
                        ...
                        <p class="text-muted mb-0">Silakan laporkan realisasi kegiatan pertama Anda dengan menekan tombol Tambah Realisasi.</p>
                    </div>
                </div>
            @endforelse
        </div>
