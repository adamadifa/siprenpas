            ...
            @foreach($questionnaires as $q)
                <tr>
                    ...
                    <td>
                        ...
                        <a href="{{ route('admin.questionnaires.questions.index', $q->id) }}" class="btn btn-secondary btn-sm">Kelola Pertanyaan</a>
                        <a href="{{ route('admin.questionnaires.show', $q->id) }}" class="btn btn-info btn-sm">Detail</a>
                        <a href="{{ route('admin.questionnaires.report', $q->id) }}" class="btn btn-success btn-sm">Report</a>
