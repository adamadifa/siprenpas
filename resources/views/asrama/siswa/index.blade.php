@extends('layouts.app')
@section('titlepage', 'Data Siswa Asrama')
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    <div class="avatar avatar-md bg-label-success rounded-circle d-flex align-items-center justify-content-center">
                        <i class="ti ti-home-check fs-3"></i>
                    </div>
                    <div>
                        <h4 class="mb-0 fw-bold" style="color: #064e3b">Data Siswa Asrama</h4>
                        <p class="text-muted mb-0 small">Manajemen data siswa aktif dengan status biaya asrama</p>
                    </div>
                </div>
                        ...
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            <li class="breadcrumb-item">
                                <a href="javascript:void(0);" class="text-muted">
                                    <i class="ti ti-home-check me-1"></i> Asrama
                                </a>
                            </li>
                            <li class="breadcrumb-item active">
                                <i class="ti ti-users me-1"></i> Data Siswa Asrama
                            </li>
                        </ol>
                    </nav>
                </div>
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
                        ...
                        @forelse ($rekap_unit as $r)
                            <div class="stat-item flex-grow-1 px-4 {{ !$loop->last ? 'border-end' : '' }}" style="min-width: 200px;">
                                ...
                                <div class="text-muted small d-flex align-items-center gap-1">
                                    <span class="small">Siswa Asrama</span>
                                </div>
                            </div>
                        @empty
        ...
        <div class="card mb-4 shadow-none border-0 bg-transparent">
            <div class="card-body p-0">
                <form action="{{ route('asramasiswa.index') }}">
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex align-items-center gap-2 text-white py-3" style="background-color: #064e3b">
                ...
                <h6 class="card-title mb-0 text-white">Data Siswa Asrama</h6>
            </div>
            <div class="card-body p-0">
                            ...
                            @empty
                                <tr>
                                    <td colspan="10" class="text-center p-5">
                                        ...
                                        <h5>Belum Ada Data Siswa Asrama</h5>
