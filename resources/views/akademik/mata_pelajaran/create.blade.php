...
<form action="{{ route('mata-pelajaran.store') }}" method="POST" id="formMatpel">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="row mb-2">
                <div class="col-6">
                 ...
                 <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="kode_matpel" placeholder="Otomatis" readonly>
                </div>
            </div>

            <div class="form-group mb-2">
                 <label class="form-label fw-bold">Nama Mata Pelajaran <span class="text-danger">*</span></label>
                <input type="text" class="form-control" name="nama_matpel" id="nama_matpel" placeholder="Nama Mata Pelajaran">
             ...
             <div class="form-group mb-2">
                ...
                <select name="parent_id" class="form-select select2">
                    ...
                    @foreach ($parents as $p)
                        <option value="{{ $p->id }}">{{ $p->nama_matpel }} (Kelompok {{ $p->kelompok }})</option>
                    @endforeach
                </select>
            </div>
