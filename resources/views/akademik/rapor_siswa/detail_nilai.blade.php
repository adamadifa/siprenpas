        ...
        <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    <a href="{{ route('rapor-siswa.show', $jadwal->kode_kelas) }}" class="btn btn-label-secondary btn-icon rounded-circle" style="color: #064e3b; background-color: rgba(6, 78, 59, 0.08);">
                        <i class="ti ti-arrow-left fs-4"></i>
                    </a>
                    <div>
                        <h4 class="mb-0 fw-bold" style="color: #064e3b">Detail Penilaian Siswa</h4>
                        <p class="text-muted mb-0 small">Halaman pemantauan rincian nilai siswa (Read-Only)</p>
                    </div>
                </div>
                <div class="d-flex flex-column align-items-end">
                    <nav aria-label="breadcrumb" class="mb-2">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ route('rapor-siswa.show', $jadwal->kode_kelas) }}" class="text-muted">Detail Progress</a>
                            </li>
...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12 mb-3">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header text-white p-2" style="background-color: #0b3d24; border-radius: 8px 8px 0 0;">
    ...
    <div class="col-12 mb-4">
        <div class="nav-align-top nav-tabs-shadow">
            ...
            <div class="p-3 d-flex justify-content-between align-items-center flex-wrap gap-2" style="background-color: #0b3d24; border-top: 1px solid rgba(255,255,255,0.1);">
