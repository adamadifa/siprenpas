                    ...
                    <div class="row g-3 align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="form-group mb-3 d-flex gap-2">
                                ...
                                <a href="{{ route('rapor.index') }}" class="btn btn-label-secondary d-flex align-items-center justify-content-center" style="height: 38px; width: 38px;" data-bs-toggle="tooltip" title="Reset Filter">
