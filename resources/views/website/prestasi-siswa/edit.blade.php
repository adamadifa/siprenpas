    ...
    <div class="col-lg-8 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Edit Prestasi Siswa</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('prestasi-siswa.update', $prestasiSiswa->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="hidden" id="id_siswa" name="id_siswa" value="{{ old('id_siswa', $prestasiSiswa->id_siswa) }}">
                                    <button class="btn btn-outline-secondary" type="button" id="btnSearchSiswa">
                                ...
                                <select class="form-select @error('kode_unit') is-invalid @enderror" id="kode_unit" name="kode_unit" required>
                                    ...
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->kode_unit }}"
                                            {{ old('kode_unit', $prestasiSiswa->kode_unit) == $unit->kode_unit ? 'selected' : '' }}>
                                            {{ $unit->nama_unit }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_siswa') is-invalid @enderror" id="nama_siswa" name="nama_siswa"
                                    value="{{ old('nama_siswa', $prestasiSiswa->nama_siswa) }}" required>
                                @error('nama_siswa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('prestasi') is-invalid @enderror" id="prestasi" name="prestasi" rows="3" required>{{ old('prestasi', $prestasiSiswa->prestasi) }}</textarea>
                                @error('prestasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('tingkat') is-invalid @enderror" id="tingkat" name="tingkat" required>
                                    ...
                                    <option value="kecamatan" {{ old('tingkat', $prestasiSiswa->tingkat) == 'kecamatan' ? 'selected' : '' }}>
                                        Kecamatan</option>
                                    <option value="kabupaten" {{ old('tingkat', $prestasiSiswa->tingkat) == 'kabupaten' ? 'selected' : '' }}>
                                        Kabupaten</option>
                                    <option value="nasional" {{ old('tingkat', $prestasiSiswa->tingkat) == 'nasional' ? 'selected' : '' }}>Nasional
                                    </option>
                                </select>
                                @error('tingkat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                @if ($prestasiSiswa->foto)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/prestasi-siswa/' . $prestasiSiswa->foto) }}"
                                            alt="Foto {{ $prestasiSiswa->nama_siswa }}" class="img-thumbnail"
                        ...
                        <div class="col-12">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                    ...
                                    <option value="1" {{ old('status', $prestasiSiswa->status) == '1' ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ old('status', $prestasiSiswa->status) == '0' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
