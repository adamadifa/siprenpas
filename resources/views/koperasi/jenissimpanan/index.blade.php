        ...
        <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 class="mb-0 fw-bold" style="color: #064e3b">Data Jenis Simpanan</h4>
                        <p class="text-muted mb-0 small">Manajemen master data jenis simpanan koperasi</p>
                    </div>
                </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="ti ti-wallet me-1"></i> Jenis Simpanan
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="col-lg-7 col-md-12 col-sm-12">
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex align-items-center gap-2 text-white py-3" style="background-color: #064e3b">
                ...
                <h6 class="card-title mb-0 text-white">Data Jenis Simpanan</h6>
            </div>
            <div class="card-body p-0">
                    ...
                    <table class="table table-hover mb-0">
                        <thead style="background-color: #064e3b">
                            <tr>
                                ...
                                <th class="text-white py-3">JENIS SIMPANAN</th>
                        ...
                        <tbody>
                            @forelse ($jenissimpanan as $d)
                                <tr>
                                    <td class="py-1"><span class="fw-bold">{{ $d->kode_simpanan }}</span></td>
                                    <td class="py-1">{{ $d->jenis_simpanan }}</td>
                                    <td class="py-1 text-end">
                                        <div class="d-flex justify-content-end gap-1">
                                            @can('jenissimpanan.edit')
                                                <a href="#" class="btn btn-icon btn-label-success border btnEdit shadow-none"
                                                    style="width: 28px; height: 28px;"
                                                    kode_simpanan="{{ Crypt::encrypt($d->kode_simpanan) }}" data-bs-toggle="tooltip" title="Edit Data">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center p-5">
                                        <div class="mb-3">
                                            <i class="ti ti-wallet fs-1 opacity-25"></i>
                                        </div>
                                        <h5>Belum Ada Data Jenis Simpanan</h5>
...
<x-modal-form id="modal" size="" show="loadmodal" title="" icon="ti ti-wallet" />
@endsection
