<form action="{{ route('jenissimpanan.store') }}" id="formSimpanan" method="POST">
    @csrf
    <x-input-with-icon-label icon="ti ti-barcode" label="Kode Jenis Simpanan" name="kode_simpanan" required="true" />
    <x-input-with-icon-label icon="ti ti-file-description" label="Nama Jenis Simpanan" name="jenis_simpanan" required="true" />
    ...
    <div class="form-group mt-3">
        <button class="btn btn-primary w-100 shadow-sm d-flex align-items-center justify-content-center gap-2" type="submit" id="btnSimpan" style="background-color: #064e3b; border-color: #064e3b">
            ...
            <span class="fw-bold">Simpan Data Jenis Simpanan</span>
        </button>
    </div>
</form>
