            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div class="d-flex align-items-center gap-3">
                    <div class="avatar avatar-md bg-label-success rounded-circle d-flex align-items-center justify-content-center">
                        <i class="ti ti-pig-money fs-3"></i>
                    </div>
                    <div>
                        <h4 class="mb-0 fw-bold" style="color: #064e3b">Data Jenis Tabungan</h4>
                        <p class="text-muted mb-0 small">Manajemen master data jenis tabungan koperasi</p>
                    </div>
                </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            ...
                            <li class="breadcrumb-item active">
                                <i class="ti ti-pig-money me-1"></i> Jenis Tabungan
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <div class="col-lg-7 col-md-12 col-sm-12">
        ...
        <div class="card shadow-sm">
            <div class="card-header d-flex align-items-center gap-2 text-white py-3" style="background-color: #064e3b">
                ...
                <h6 class="card-title mb-0 text-white">Data Jenis Tabungan</h6>
            </div>
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            @forelse ($jenistabungan as $d)
                                <tr>
                                    <td class="py-1"><span class="fw-bold">{{ $d->kode_tabungan }}</span></td>
                                    <td class="py-1">{{ $d->jenis_tabungan }}</td>
                                    <td class="py-1 text-end">
                                        <div class="d-flex justify-content-end gap-1">
                                            @can('jenistabungan.edit')
                                                <a href="#" class="btn btn-icon btn-label-success border btnEdit shadow-none"
                                                    style="width: 28px; height: 28px;"
                                                    kode_tabungan="{{ Crypt::encrypt($d->kode_tabungan) }}" data-bs-toggle="tooltip" title="Edit Data">
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center p-5">
                                        <div class="mb-3">
                                            <i class="ti ti-pig-money fs-1 opacity-25"></i>
                                        </div>
                                        <h5>Belum Ada Data Jenis Tabungan</h5>
...
<x-modal-form id="modal" size="" show="loadmodal" title="" icon="ti ti-pig-money" />
@endsection
