            ...
            <tbody>
                @foreach ($laporan_presensi as $d)
                    ...
                    <tr>
                        ...
                        <td style="width:2%">'{{ $d['npp'] }}</td>
                        <td style="width:5%">{{ $d['nama_lengkap'] }}</td>
                        <td style="width:3%">{{ $d['nama_jabatan'] }}</td>
                        <td style="width:2%">{{ $d['nama_unit'] }}</td>
                        @php
                            $total_denda = 0;
                            ...
                            @if (isset($d[$tanggal_presensi]))
                                @if ($d[$tanggal_presensi]['status'] == 'h')
                                    @php
                                        ...
                                        if ($terlambat != null) {
                                            $denda = hitungdenda($terlambat['menitterlambat'], $d['status_karyawan']);
                                        } else {
                                            $denda = 0;
                                        }
