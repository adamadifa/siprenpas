...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $seeders = [
            ...
            JobdeskStaffMsdmPesantrenSeeder::class,
            JobdeskStaffEkonomiPesantrenSeeder::class,
            JobdeskSekretarisBphPesantrenSeeder::class,
            JobdeskKepalaSekretariatSkrPesantrenSeeder::class,
            JobdeskKabidPendidikanPesantrenSeeder::class,
            JobdeskKabidMsdmPesantrenSeeder::class,
            JobdeskKabidHaloPesantrenSeeder::class,
