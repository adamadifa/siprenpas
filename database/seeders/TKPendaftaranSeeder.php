...
class TKPendaftaranSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $records = [
            ['nama_lengkap' => 'ARRRAYAN ARSY FAIDHAN', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'DZAKY NAUFAL AL GHIFARY', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'SHAQUILLE F', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'HANAN HABIBILLAH', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'ANINDA FARRA SHABIRA AFIFA', 'jenis_kelamin' => 'P'],
            ['nama_lengkap' => 'NAUFAL RAMADHAN MUBARAQ', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'ARSHAKA KHALID ALFARUQ', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'ADINDRA HAYYI MAHESWARI', 'jenis_kelamin' => 'P'],
            ['nama_lengkap' => 'MUHAMMAD SHIDQI ABQARY', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'AHMAD GIANDRA FIRMANSYAH', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'SAYYID HANAN MALIK', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'NIZAMUDIN AKBAR', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'FAIQ KARIM ALJAELANI', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'FARADILLA', 'jenis_kelamin' => 'P'],
            ['nama_lengkap' => 'MUHAMMAD ALFATIH', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'BIMA PUTRA PRAYITNO', 'jenis_kelamin' => 'L'],
            ['nama_lengkap' => 'ARSYAD', 'jenis_kelamin' => 'L'],
        ];
        ...
        $this->command->info("Berhasil membuat seeder untuk {$count} data pendaftaran TK 2026/2027.");
    }
}
